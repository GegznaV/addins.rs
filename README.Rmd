...
[![Travis-CI Build Status](https://travis-ci.org/GegznaV/addins.rs.png?branch=master)](https://travis-ci.org/GegznaV/addins.rs)
...
knitr::include_graphics("http://gegznav.github.io/addins.rs/logo.png")
```
-->
***
